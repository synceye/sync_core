...
-- DISCORD WEBHOOK --
Config.url = "DISCORD CHANNEL WEBHOOK URL" -- PASTE YOUR WEBHOOK URL HERE TO ENABLE CHAT TO DISCORD --
Config.image = "DISCORD WEBHOOK IMG" -- PASTE YOUR IMAGE URL IF YOU WANT IT TO BE DISPLAYED --
-- DISCORD WEBHOOK --
